...
export const ENDPOINTS: Endpoint[] = [
  ...
  { method: "GET", path: "/analytics/accounts", group: "Analytics", name: "Tracked accounts", description: "Performance and CPM rolled up by creator handle.", defaultQuery: "page=1&limit=10&sortBy=totalViews&sortOrder=desc" },
  { method: "GET", path: "/analytics/overview", group: "Analytics", name: "Analytics overview", description: "Summary with CPM, top posts, top creators, and platform mix." },
